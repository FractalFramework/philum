...
case('words1'):$rb['words'][]=togbub('mod,artmod',$id,picto('related')); break;//related
...
case('words10'):$rb['words'][]=togbub('mod,callmod','m:related,p:'.$id.',t:'.nms(225),picto('art-tags'),'',att(nms(225))); break;
