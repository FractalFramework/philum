...
case('cat'):$rb[$v]=self::backcat($r['frm'],$rst[43]); break;
...
if(rstr(64))$d=codeline::parse($d,'figure q twitter table msql iframe','stripconn');//thumb
if(rstr(34)){
...
if($prw=='rch' && $tp)$out=self::prepare_rech($id,$msg,$out); else
