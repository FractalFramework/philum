...
$id=sqb::read('id','art','v',['or'=>['mail'=>$f,'%suj'=>$d],'_limit'=>'1']);
//$id=sql('id','qda','v',['or'=>['mail'=>$f,'%suj'=>$d],'_limit'=>'1']);
//if(!$id)$id=sql('id','qda','v',['%suj'=>$d,'_limit'=>'1']);
return $id;}
...
$ret.=lj('','adc_sav,batchprep__3_'.ajx($u),picto('update'),'put all in cache');//216
