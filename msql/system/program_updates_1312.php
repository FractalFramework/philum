...
5=>['1214','unification des systèmes de liens prédéfinis : 
- sources : mod link, mod url, mod user_menu, conn link, codeline link ;
- destinations : chaîne, ou array type link, pour listes'],
6=>['1217','ajout du module MenusP, le même que MenusJ mais dans une popup (liste de menus rédigés sous forme de commande) '],
7=>['126','ajout des plugins:
