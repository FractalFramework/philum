...
3=>['0222','ajout d\'un composant pour l\'édition de l\'article parent, disponible dans les divers points d\'entrée d\'un article (rss, batch, admenu, édition) ;rntous ces points d\'entrée sont rendus sensibles à la config des restrictions (save in popup, autoparent, autopublish) ;'],
4=>['0223','amélioration du batch :rn- les sélecteurs de contexte de l\'article (catégorie et parent) s\'affichent lors de l\'importation ponctuelle ;rn- on peut préparer la catégorie d\'un article avant le batch ;rn- le résultat du batch utilise le module \'recents\' ;'],
