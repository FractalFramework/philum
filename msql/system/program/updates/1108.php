...
6=>['110807','ajout des restrictionsrn- \'auto_parent\' : définit si le nouvel article utilise celui en cours comme parent ;rn- \'auto_publish\' : publie automatiquement un nouvel article ;'],
...
22=>['110814','ajout d\'une imbrication de requête mysql pour améliorer le résultat des tris multiples, quand une langue est sélectionnée (la vitesse reste à améliorer) ;rnle module \'articles\' devient capable de trier les langues'],
...
25=>['110816','connecteur \':codeline\' : affiche le rendu d\'un template en codeline : chaque ligne doit contenir une instruction sans les crochets au début et à la fin de la ligne. rnCe fonctionnement particulier oblige le logiciel à lire le contenu du connecteur en mode \'codeline\'.'],
26=>['110816','connecteur \':thumb\' : fabrique des miniatures avec des dimensions personnalisées : [img.jpg|140/100:thumb]rnrn:thumb est une instruction de Codeline (pour les templates), mais n\'était pas disponible pour les connecteurs logiciels (articles)'],
...
31=>['110818','correctifs sur :photo2 :rn- supporte les images de l\'EDU (espace disque utilisateur) ;rn- première image qui ne s\'affichait pasrn- capacité d\'en mettre plusieurs sur une page ;rn- timer (en chantier)'],
32=>['110819','finalisation de :sliderJ : rn- fonctionnement palpé sur :photo2 (ajax)rn- révision de la mémorisation de la position ;'],
33=>['110819','correctifs sur :photo2 et :photo :rn- défilement en bouclern- supporte les sources hétérogènes (EDU ou image d\'article)rn- révision de la compatibilité entre les 3 sortes de sources et les 3 sortes de rendus (9 combinaisons)'],
34=>['110820','sliderJ : rn- affiche les miniatures qui défilent quand on clique dessus si on ajoute \'|1\' : \'[table|1:sliderJ ]\'rn- peut être appelé plusieurs fois'],
...
38=>['110822','ajout d\'options dans master_config (niveau 7) :rn- timezone : fixe le fuseau horaire (Europe/Paris) ;rn- error_report : niveau du rapport d\'erreurs (en dev, NULL en prod) ;'],
39=>['110823','mise en conformité de l\'installer avec PHP 5.3 et ses préférences :rn- fichier .user.inirn- error_rporting à E_STRICTrn- permission 705'],
40=>['110823','les petits articles sont enregistrés en ajax'],
41=>['110824','la galerie ajax :photo2 démarre à la première image et non la deuxième ;rnla galerie SliderJ est capable de gérer les liste d\'objets discontinus (quand une entrée a été effacée)'],
...
44=>['110828','ajout du support de modules d\'article :rn- module système \'art_mod\', où on spécifie la commande de modules, comme dans tab_mods (onglets html) ou MenusJ (appelés en ajax);rn- en option la largeur par défaut est de 160, ce qui permet de redimensionner les contenus qui se trouvent ejectés par la colonne additionnelle ;rn- template révisé pour supporter la variable ARTMOD ;'],
45=>['110829','aujout du support de nomination des termes usuels utilisés par le logiciel :rn- ajout la table lang/helps_nominations (31 intitulés) ;rn- application de la sessions \'nms\'  (27 placements) ;rnles nominations actuelles sont préliminaires.'],
