...
2=>['110703','l\'option \'nobr\' des modules (qui sert à ne pas ajouter un saut de ligne après un module) devient conformiste : ajout d\'une colonne dans la table des modules, n\'entre plus en contradiction avec d\'autres options.rnUn patch doit être exécuté pour la mise en conformité'],
...
13=>['110710','rénovation du gestionnaire de fichiers utilisateur :rn- confort d\'utilisation ;rn- miniatures des images ;rn- système de miniatures (aussi générées par une navigation côté utilisateur dans le module \'disk\') déplacé dans un autre répertoire que celui de l\'utilisateur ;rn- suppression d\'un répertoire et son contenu ;rn- sécurité des systèmes de suppression ;rn- ajout du bouton \'share\' qui propose de partager un fichiers ;rn- ajout de la base server/shared_files ;rn- amélioration gestionnaire interne des modifications des microbases (les fonction \'msql_\' sont orientées utilisateur) ;'],
14=>['110714','ajout du plugin \'share\' : permet de naviguer et downloader les fichiers partagés par les autres hubs dans \'admin/disk\' ; rnLa présentation peut trier par hubs ou combiner les catégories ;rnLes sons, images, vidéos et textes peuvent être visualises ; rnLes fichiers partagés utilisent un répertoire virtuel que l\'administrateur peut générer pour faciliter le classement et la recherche ;'],
...
20=>['110728','finalisation du plug-in taxo_nav, accessible par le module du même nom :rn- capacité à ouvrir/fermer les noeuds en ajax ;rn- capacité à creuser dans le temps pour chercher des parents éloignés et ainsi produire une taxonomie plus développée'],
