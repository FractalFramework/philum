...
2=>['1102','- ajout d\'un éditeur pour les sous-modules ;rn- dans user_menu le bouton \'tools\' renvoie un accès à la racine du desktop, nommée \'tools\' ;rn- fix pb dossier vide dans finder ;rn- ajout d\'aides dans l\'édition des sous-modules ;'],
3=>['1103','- le plugin twitter reçoit le hashtag en paramètre rendu éditable par le visiteur ;rn- rénovation plugin exec, usage des popups ;'],
...
13=>['1113','- ajout du connecteur \':color\' (reçoit un hexa) ;rn- ajout du codeline \':span\' qui se comporte comme \':div\' (reçoit d\'autres connecteurs comme \':style\') ;rn- ajout du paramètre serveur \'ajax_buffer\' (admin/params/server) pour ajuster soi-même la taille du buffer AMT, 1500 par défaut ;rn- réhabilitation des rss, qu\'on peut appeler comme ceci : /plugin/rss/hub/preview'],
...
15=>['1115','- ajout d\'une aide à l\'édition du module \'articles\' ;rn- nouvelle présentation du panneau \'ajouter modules\' ;rn- introduction des variables d\'article \'jurl\' et \'purl\' pour ouvrir en ajax dans le content ou dans une popup ;rn- ajout du codeline \':jurl\' : [_PURL|_SUJ:jurl]rn- le module Category accepte les templates ;'],
16=>['1116','- ajout de l\'attribut \'scrold\' (d pour défile) pour retrouver les barres de défilement rendues invisibles par l\'esthétique ;rn- ajout de  l\'attribut \'auto\' au mode d\'affichage de l\'article (preview, false, true) : défini par le niveau de priorité de l\'article (2=preview) ;'],
17=>['1117','- le mot \'Home\' fait appel à sa nomination (accueil en fr) ;rn- rénovation de la présentation des taxonomies ;rn- réparations sur l\'éditeur de font-faces ;rn'],
