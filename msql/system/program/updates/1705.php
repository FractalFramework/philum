...
3=>['0503','mise à niveau du dispositif panup :rn- le panneau ne recouvre pas le menu de premier niveaurn- les css indiquent le menu actif du panneau en cours'],
4=>['0503','finalisation de slct_cases :rn- amélioration de la recherche via les tagsrn- suppression de l\'antique rech_catag()rn- ajout de maxdays() et oldest_art(), pour survenir aux manquements quand rstr3 n\'est pas actif ; maxdays() supporte les dates négatives.'],
