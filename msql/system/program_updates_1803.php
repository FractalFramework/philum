...
4=>['0306','rénovation du formulaire de commentaire pour éviter les collisions avec les autres éditeurs ouverts'],
5=>['0311','réparation de la signalisation des contextes particuliers des articles au moment de leur déroulé depuis un appel exogène de l\'API (signalement de la langue par ex)'],
...
(pour fêter l\'arrivée du printemps et des nouveaux ascii couleur, on anticipe une future standardisation de cet usage)'],
7=>['0314','- déplacement du lecteur de radio dans un plugin
- confiscation du procédé rendu obsolète \'miniconn\'
- réforme du procédé \'sconn\', réduit à l\'essentiel pour servir à l\'édition rapide d\'un article'],
8=>['0317','- ajout de la classe css globale \'sticky\' qui s\'applique au menu de mise en forme d\'un texte édité sur place en wyswyg (pour qu\'il reste à l\'écran quand on scroll)
...
- ajout d\'une gestion des traduction dans l\'éditeur de métas'],
9=>['0320','- ajout de la typo GlyphiconsHalfings, et du dispositif \'glyph\' (avec son connecteur :glyph), qui complète \'icons\', \'pictos\', et \'ascii\' : beaux pictos bien fonctionnels pompés sur le site de pole-emploi'],
10=>['0321','- ajout de l\'option-utilisateur \'preview\', permet de supplanter le, et revenir au niveau de prévisualisation des articles de l\'API.
- révision de la nomination des langues, en conformité avec les conventions internationales'],
11=>['0324','- rénovation du connecteur :jukebox, le lecteur flash antique est oublié et à la place on met un joli sélecteur ajax de lecteur html5'],
12=>['0328','- le panneau ascii de l\'éditeur ouvre vers un autre panneau des connecteur ascii
