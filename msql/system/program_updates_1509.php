...
3=>['0902','- le connecteur :track renvoie le contenu plutôt qu\'un bouton vers popup, du commentaire prit en référence
...
4=>['0903','- amélioration du traitement (rendu récursif) du connecteur :track, pour lire les commentaires pris en référence
...
7=>['0909','- ajout du plugin genpswd, génère un mot de passe naturel avec accents et nombres
- ajout du plug md5'],
8=>['0910','- fix pb liens à variables dans l\'interprétateur (depuis le fix précédent)
