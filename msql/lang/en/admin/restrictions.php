...
'8'=>['prw auto','preview mode auto for ibarts'],
...
'18'=>['public defcons','Définitions for importations of articles. rnSet public or private defs in rstr18'],
...
'85'=>['desktop','boot apps of desk type (load desktop) and display link in a popup'],
...
'107'=>['language sorting','sort button to current language'],
...
'145'=>['save videos','Connectors [mp4, mp3, webm, m4a, ogg] omit recording, which is normally controlled by the use of the associated connectors.rnIf rstr is deactivated, the opposite is true: only urls converted to connectors (.mp4 =&gt; :mp4) cause recording.'],
...
'152'=>['autoreduce','reduce image width at 940px'],
'153'=>['progc','dev2'],
...
'160'=>['overcat','color of cat'],
'161'=>['front','?'],
'162'=>['json','use json templates'],
'163'=>['glyphs','sets image height < 120px to 1 em'],
'164'=>['dico','defined words'],
'165'=>['plan','article outline'],
'166'=>['videos','import videos'],
'167'=>['srvimg','save local images from srvimg server'],
'168'=>['noim','template preview1 with no image'],
'169'=>['onetag','autor'],
'170'=>['related','related arts'],
'171'=>['edit preview','auto preview'],
'172'=>['search react','displays results by typing']]; ?>