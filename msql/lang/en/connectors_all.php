...
"color"=>['color of text : [textÂ§dd0000:color] [textÂ§indigo:color] '],
"cols"=>['put the content into columns : [Â§3:cols] (number), [Â§300:cols] (size in px)'],
"block"=>['put the content into a block : [Â§3:block] (%), [Â§300:block] (size in px)'],
"center"=>['center align'],
...
try [id:readÂ§screen:ajax] give the content of an article '],
"ajxget"=>['preserve characters Â§ inside connector :module '],
"dskbt"=>['calls a button of type Desk 
- from an existing id: [6:dskbt][6Â§hello:dskbt]
...
"bkg"=>['background image : [valueÂ§img:bkg] (first from catalog by default)'],
...
"draw"=>['external Api'],
"font"=>['font of text [pHilUMÂ§microsys:font]'],
...
"iframe"=>['give an iframe from an URL [srcÂ§width/height/name/seamless:iframe]'],
...
"imgdata"=>['datas of an image [datasÂ§jpeg:imgdata]'],
...
- key: Home, ID, catÃ©gorie, module
- title: HomeÂ§Accueil
- picto : HomeÂ§home:picto
- url: /?plug=myplugÂ§name_of_plug 
- key: Home'],
"w"=>['give entire link'],
...
"mini"=>['build a thumbnail with personalized dimensions : [img.jpgÂ§140/100:mini]
+ open the original in an ajax popup'],
"module"=>['displays one or more modules, directly or via a Â§button, according to the syntax [m:module,p:param,t:titleÂ§button:module].'],
...
"mp4"=>['player mp4 (and m3u) ; Â§tilre returns a button opening a popup'],
...
"plug"=>['[paramÂ§option:plugin:plug]'],
"app"=>['[paramÂ§option:app:appin]'],
"appbt"=>['button to an app [pÂ§o:appÂ§bt:appbt]'],
"connbt"=>['button to a connector [pÂ§o:cÂ§bt:connbt]'],
"figure"=>['[image.jpgÂ§texte:figure]'],
"pop"=>['open content in a popup [textÂ§title:pop]'],
"popart"=>['open an article Philum (local or distant) in a popup'],
"popmsqt"=>['return content from a msql entry in a popup ; [system_program*gnu_1Â§GNU:popmsqt] '],
...
[1234Â§1:pub] Â§2 Â§3 Â§4 open article (preview mode)'],
"art"=>['[1234:art] display button
[1234Â§1:art] Â§2 Â§3 Â§4 open article (preview mode)'],
...
"scan"=>['import the content of text file.  Â§1 will convert connectors of content'],
...
"size"=>['size of text [textÂ§24:size] '],
"t"=>['css: txtit (titles)'],
"del_tables"=>['del tables'],
"thumb"=>['build a thumbnail with personalized dimensions : [img.jpgÂ§140/100:thumb]'],
...
"video"=>['read a video youtube daily vimeo rutube etc... Â§1 return a link to open a popup'],
...
"popmsql"=>['return content from a msql entry in a popup ; [public_atomicÂ§GNU:popmsql]'],
"image"=>['open an external image, from any format'],
"slides"=>['create a slide [:slide] param (opt) : title, else id is used'],
"fluid"=>['create a fixed image entirely visible while scrolling (Â§height) [img.jpgÂ§100:fluid]'],
"float"=>['floating div Â§1=right'],
"sigle"=>['code of currencies (euro, dollar, yen...)'],
"caviar"=>['cavalize the text'],
"typo"=>['ascii equivalent [helloÂ§4:transcript]'],
"flag"=>['ascii flag from country-code'],
"bkgclr"=>['color of background of text : [textÂ§yellow:bkgclr]'],
"stabilo"=>['stabilo boss [textÂ§orange:stabilo] (green, blue, yellow=default)'],
"red"=>['red text'],
"blue"=>['blue text'],
"parm"=>['parm text'],
"green"=>['green text'],
...
"toggle_text"=>['open content on place [contentÂ§title:toggle_text]'],
"toggle"=>['open content in a blockquote [contentÂ§title:toggle]'],
"toggle_note"=>['open content in a bubble [contentÂ§title:toggle_note] with not hidden content'],
"bubble_note"=>['open content in a bubble [contentÂ§title:bubble_note] using ajax'],
"toggle_conn"=>['opens an on-site ajax connector: [248:readÂ§open:jconn] (or artID only)'],
"exec"=>['execute code'],
"api"=>['call Api'],
"papi"=>['button to call Api'],
"tag"=>['call the results from a tag : [keyworkÂ§classTag:tag]'],
...
"plan"=>['table of contents, using h1, h2...
 [titleÂ§option:plan] opt=1 : topologic number'],
"frame"=>['[txtÂ§red:frame] add a red frame around the text'],
"underline"=>['[txtÂ§red:frame] add a red line under the text'],
"look"=>['opens an article by highlighting a term [idÂ§word:look]'],
"lang"=>['translation of text [textÂ§(es/en/fr/...):lang]'],
