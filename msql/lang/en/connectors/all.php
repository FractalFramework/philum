...
'prog'=>['give the syntax coloration for prog code'],
'clr'=>['[txt|red:clr] red text'],
...
'center'=>['center align'],
'ajax'=>['returns (a button who return) a module or a connector :ajax
where:
...
'bkim'=>['[txt|img.jpg:bkim] background image'],
...
'iframe'=>['give an iframe from an URL [url:iframe]'],
...
'slide'=>['slider of text. Use -- as separator'],
...
'effect'=>['class effect; image filter'],
...
'search'=>['result of inte
al search engine (knowing time_system)'],
...
'twitter'=>['open a twit from it\'s ID or a thread from it\'s use
ame'],
...
'red'=>['red text'],
'ured'=>['red underscore'],
'color'=>['[txt|red:clr] red text'],
'border'=>['[txt|red,2,solid:border] 2px red border'],
'deco'=>['[text|red,2,solid,underline:deco] red underline'],
'under'=>['[txt|red:under] red underline'],
'over'=>['[txt|red:over] red overline'],
'dotted'=>['[txt|red:udotted] red dotted underline'],
'dashed'=>['[txt|red:dashed] red linear dotted underline'],
'double'=>['[txt|red:dotted] red double underline'],
'strike'=>['[txt|red:strike] strikethrough text'],
'wavy'=>['[txt|red:strike] vague underline'],
'underover'=>['[txt|red:underover] underlining above and below'],
'borderline'=>['[txt|red,2,solid:borderline] 2px red border-bottom'],
...
'note'=>['content displayed in a bubble [content|title:note]'],
'notes'=>['result of footnotes collected by :note'],
'exec'=>['execute code'],
'api'=>['call Api'],
