...
'prog'=>['give the syntax coloration for php code'],
...
'mp4'=>['player mp4 (and m3u) ; |tilre retu
s a button opening a popup'],
...
'popmsqt'=>['retu
 content from a msql entry in a popup ; [system_program*gnu_1|GNU:popmsqt] '],
...
'video'=>['read a video youtube daily vimeo rutube etc... |1 retu
 a link to open a popup'],
'audio'=>['audio file with no import'],
'play'=>['play directly the video'],
'web'=>['retu
s the presentation of a web page'],
'webm'=>['webm videos'],
...
'popmsql'=>['retu
 content from a msql entry in a popup ; [public_atomic|GNU:popmsql]'],
'image'=>['open an exte
...
'wiki'=>['retu
s the header of the wikipedia page if there is a linked text, otherwise retu
s its entire content.'],
