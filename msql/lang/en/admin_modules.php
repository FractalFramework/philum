...
'catarts'=>['articles from a category','specify the category','lang=en','render'],
...
'desktop'=>['params ofdesktop','background : html color, gradient,&nbsp; image or directory (random img)','',''],
...
'player'=>['','','',''],
'app'=>['call an app','name of the app','target of asynchronous call if pp is activated',''],
...
'BOOT'=>['Modules to launch at Boot','','',''],
'DESK'=>['Desktop modules','Can receive a MENU module','',''],
'ADMIN'=>['Admin modules','Can receive a MENU module','',''],
