...
'deco'=>['Decorations can be called up via simplified or explicit connectors, and shortcuts.
- :under, :double, :dotted, :dashed, :wavy, :strike, :over, :underover: are expressions of :deco.
- :u{clr} is a shortcut of :under
- :bdr{clr} is an expression of :border
- :bkg{clr} = background
- :bdl = :borderline is an expression of border with attribute bottom'],
'pictos'=>['List of system pictograms, due to the \'philum\' typeface.
...
- a term in any language
- a list of ids or titles (ot-100,1873,312-14) (also in spreadsheet mode)'],
'clusters'=>['Tag clusters: generic categories obtained by emergence'],
