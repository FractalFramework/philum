...
145=>['save videos','Connectors [mp4, mp3, webm, m4a, ogg] omit recording, which is normally controlled by the use of the associated connectors.
If rstr is deactivated, the opposite is true: only urls converted to connectors (.mp4 =&gt; :mp4) cause recording.'],
