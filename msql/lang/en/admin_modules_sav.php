...
"ARTMOD"=>['Calls a block of modules with an article','Name of the block','','display mode'],
...
"app_link"=>['button to an App','syntaxe or id of the line in the user apps table, or of the table of the param \'command\'','',''],
...
"link"=>['return a link (protocol)','predefined links :
...
"playconn"=>['article containing the specified connector','specify the connector in option','',''],
