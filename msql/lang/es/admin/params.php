...
16=>['article deadline in number of daysrnvalor][auto = frecuencia: 50 arts/period]'],
17=>['[default ymd:Hi][d/m/Y H:i]'],
18=>['additional tag classes (separator : space)'],
19=>['usertags icons (respect position)'],
21=>['separator : space'],
23=>['upload'],
24=>['permissions reference server (http://philum.fr)rnusado para actualización, tickets, y artículos en miniatura de chatXml'],
25=>['language system'],
