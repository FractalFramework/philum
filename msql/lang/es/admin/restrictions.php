...
'8'=>['prw auto','modo de previsualización automática de subartículos'],
...
'17'=>['columns','articles on multiples columns, as set by the css \'cols\' ;rnonly long content is affected'],
'18'=>['public defcons','Définitions for importations of articles. rnThe public base represent a risk to loose his datas.rnUsing private Defcon let upgrade from public base and informe it of new entries. (in 01L editor)'],
...
'53'=>['save in ajax','save articles in ajax'],
...
'70'=>['retape','resave articles with old definitions'],
...
'85'=>['escritorio','inicia aplicaciones de escritorio y muestra enlaces en una ventana poppup'],
...
'107'=>['clasificación lingüística','idioma actual botón de clasificación'],
'108'=>['scan src','open a scan from original source'],
'109'=>['take notes','activates text highlighting associated with a comment'],
'110'=>['user-preview','user preview level'],
'111'=>['webview','muestra una vista previa automática en cada enlace'],
'112'=>['picto-category','imágenes asociadas a las categorías'],
'113'=>['last update','última actualización de un artículo'],
'114'=>['saved searches','palabras reconocidas en búsquedas guardadas'],
'115'=>['translations','muestra las traducciones existentes'],
'116'=>['twitart','tweets publicados nivel 2+ posts con cuenta 4'],
'117'=>['firstlines','la vista previa muestra los inicios de los 7 primeros párrafos'],
'118'=>['api art','compartir artículo a través de una Api'],
'119'=>['humeurs','adjuntar un estado de ánimo a un post'],
'120'=>['admbub','administrar en un menú bub'],
'121'=>['reduce img','reduce el tamaño de imágenes grandes'],
'122'=>['autonight','modo nocturno automático'],
'123'=>['especial gatos','categorias externas'],
'124'=>['favs specials','fechas externas (jda)'],
'125'=>['agree','aprobación de artículos'],
'126'=>['trk-agree','aprobación de comentarios'],
'127'=>['cluster-tags','buscar similitudes por grupos de etiquetas'],
'128'=>['same tags','artículos con las mismas etiquetas'],
'129'=>['dÃ©tect lang','detecta el idioma de un nuevo artÃculo'],
'130'=>['epub','exportar ebook'],
'131'=>['html','exportar html'],
'132'=>['videoplayer','reproducir vÃdeo directamente en el artÃculo'],
'133'=>['videolooker','buscar información de vídeo utilizando la api'],
'134'=>['ibarts','pedir artículos infantiles'],
'135'=>['highlighting','habilitar el resaltado de notas, hechos y citas (sólo para editores)'],
'136'=>['op-pagup','up en modo de enfoque'],
'137'=>['headings','reducir h1,h2,h3,h4,h5 a :h'],
'138'=>['fullscreen','desplaza el artículo a pantalla completa'],
'139'=>['notbigimg','reduce las imágenes grandes'],
'140'=>['cache','almacena los artículos actuales'],
'141'=>['book','lectura cómoda'],
'142'=>['original','imagen original'],
'143'=>['blockim','bloquea imágenes'],
'144'=>['prevnext','navegar popups de artículos'],
'145'=>['save videos','Los conectores [mp4, mp3, webm, m4a, ogg] omiten la grabación, normalmente controlada por el uso de conectores asociados.rnSi el rstr está desactivado, ocurre lo contrario: sólo las urls convertidas en conectores (.mp4 =&gt; :mp4) dan lugar a grabación.'],
'146'=>['deskhome','limita el alcance del escritorio a home'],
'147'=>['png2jpg','espera a convertir png a jpg si es ventajoso'],
'148'=>['webp2jpg','convierte webp a jpg'],
'149'=>['hurl','titular enlace en modo hurl (usa href como js)'],
'150'=>['clusters','familias de etiquetas'],
'151'=>['restoreim','restaura la img original si falta'],
'152'=>['autoreduce','reducir el ancho de la imagen a 940px'],
'153'=>['progc','dev2'],
...
'158'=>['twdie','no twitter api'],
'159'=>['togprw','toggle preview'],
'160'=>['overcat','categoría color'],
'161'=>['front','?'],
'162'=>['json','utilizar plantillas json'],
'163'=>['glifos','ajusta la altura de las imágenes < 120px a 1 em'],
'164'=>['dico','palabras definidas'],
'165'=>['plan','esbozo de artículo'],
'166'=>['videos','importar vídeos'],
'167'=>['srvimg','guardar imágenes localmente desde el servidor srvimg'],
'168'=>['noim','template preview1 no image'],
'169'=>['onetag','author'],
'170'=>['related','related arts'],
'171'=>['editar vista previa','vista previa automática'],
'172'=>['buscar reaccionar','muestra los resultados tecleando']]; ?>