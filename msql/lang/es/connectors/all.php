...
'prog'=>['muestra código con resaltado de sintaxis'],
'clr'=>['[txt|red:clr] texto rojo'],
...
'bkim'=>['[txt|img.jpg:bkim] imagen de fondo'],
...
'iframe'=>['devuelve un \'iframe\' de un enlace html: [url:iframe].'],
...
'slide'=>['powerpoint ; -- como separador'],
...
'effect'=>['clase efecto; filtro sobre una imagen'],
...
[1234|1:art] |2 |3 |4 abre el artículo (modo vista previa)'],
...
'red'=>['texto rojo'],
'ured'=>['subrayado rojo'],
'color'=>['[txt|red:clr] texto rojo'],
'border'=>['[txt|red,2,solid:border] borde rojo de 2px'],
'deco'=>['[text|red,2,solid,underline:deco] subrayado (rojo 2px)'],
'under'=>['[txt|red:under] subrayado rojo'],
'over'=>['[txt|red:over] descatar rojo'],
'dotted'=>['[txt|red:dotted] subrayado punteado rojo'],
'dashed'=>['[txt|red:dashed] subrayado lineal punteado rojo'],
'double'=>['[txt|red:dotted] subrayado doble rojo'],
'strike'=>['[txt|red:strike] texto tachado'],
'wavy'=>['[txt|red:wavy] subrayado vago'],
'underover'=>['[txt|red:underover] subrayado arriba y abajo'],
'borderline'=>['[txt|red,2,solid:borderline] borde inferior rojo de 2px'],
...
'note'=>['contenido mostrado en una burbuja [contenido|título:nota]'],
'notes'=>['resultado de las notas a pie de página recogidas por :note'],
'exec'=>['ejecuta código'],
'api'=>['llamar Api'],
