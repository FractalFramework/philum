...
":(x)"=>['delete all connectors'],
":b"=>['delete the connectors :b'],
":c"=>['delete the connectors :c'],
":h"=>['delete the connectors :h'],
":h2"=>['delete the connectors :h2'],
":i"=>['delete the connectors :i'],
":list"=>['delete the connectors :list'],
":no"=>['delete the connectors :no'],
":q"=>['delete the connectors :q'],
":s"=>['delete the connectors :s'],
":u"=>['delete the connectors :u'],
...
"bubble"=>['openable ajax submenus (see module submenus)'],
...
"draw"=>['external Api'],
"easy_tables"=>['make tables easier to edit'],
...
"jconn"=>['call a connector on place in ajax; ex: [248:read|open:jconn]'],
"jopen"=>['open a content on place in ajax'],
...
"msq_form"=>['let the visitor add an entry n a msql table ; form to use in parameter : date=date,choice1/choice2=list,entry1,entry2,message=text,image=upload,mail=mail,ok=button'],
"msq_read"=>['use datas of table msql in a template.
...
"msq_bin"=>['replace 1 ans 0 by explicit images'],
"msq_conn"=>['convert the datas of a microsql table with connectors to html'],
"msq_count"=>['return the number of lines of a microbase'],
"msq_graph"=>['make a graph from a column or a line of a table ; ex: 
from a column : [node_base|col:msq_graph ]
from a line : [node_base_key:msq_graph]'],
"msq_lasts"=>['[node|10:msq_lasts] return the 10 lasts elements of the table'],
...
"swf"=>['return a link who return an ajax popup with the Flash animation. [width/large|src:swf]'],
"t"=>['css: txtit (titles)'],
"tables"=>['detele tables'],
...
":color"=>['color of text'],
":bkgclr"=>['color of bakground of text'],
"u-red"=>['red underscore'],
"u-blue"=>['blue underscore'],
"u-green"=>['green underscore'],
"u-purple"=>['purple underscore'],
"callin"=>['open content on place [content|title:callin]'],
"exec"=>['execute code'],
"api"=>['call Api'],
