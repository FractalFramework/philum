...
'code'=>['balise code'],
'aside'=>['bloc isolable'],
'prog'=>['affiche du code source avec sa coloration syntaxique'],
'clr'=>['[txt|red:clr] texte rouge'],
...
syntaxe :&nbsp;[param/title/command/option:module-&gt;target|button[,]:ajax]&nbsp;
où :&nbsp;
- param/title/command/option:module ;&nbsp;- target = div cible ;
- button = à afficher ;La séquence peut être répétée en utilisant la virgule comme séparateur, de façon à produire un menu.
...
'bkg'=>['[texte|yellow:bkg] fond rouge'],
'bkim'=>['[txt|img.jpg:bkim] image de fond'],
...
'iframe'=>['renvoie une \'iframe\' d\'un lien html : [url:iframe]'],
...
- lien interne : /app=myapp|name_of_plug'],
'w'=>['affiche le lien en entier'],
'msql'=>['Renvoie les données d\'une table :&nbsp;
[hub_table_(version)-(key)|(row)|option:microsql] ;Options : pop, read, conn, last, count, graph, form, tmp'],
'mini'=>['fabrique une miniature d\'une image avec des dimensions personnalisées : [img.jpg|140/100:mini] + lien vers l\'original dans une popup en ajax'],
'sim'=>[':mini de 20px de haut'],
...
'slide'=>['Diapositives ; utiliser -- comme séparateur'],
...
'effect'=>['class effect; filtre sur une image'],
...
'pub'=>['[1234:pub] affiche un lien [1234|1:pub] |2 |3 |4 ouvre article (preview mode)'],
'art'=>['[1234:art] affiche un lien [1234|1:art] |2 |3 |4 ouvre article (preview mode)'],
...
'red'=>['texte rouge'],
'ured'=>['soulignement rouge'],
'color'=>['[txt|red:clr] texte rouge'],
'border'=>['[txt|red,2,solid:border] bordure rouge de 2px'],
'deco'=>['[text|red,2,solid,underline:deco] soulignement (rouge 2px)'],
'under'=>['[text|red:under] soulignement (rouge)'],
'over'=>['[text|red:over] surlignement (rouge)'],
'dotted'=>['[text|red:dotted] soulignement en pointillés(rouges)'],
'dashed'=>['[txt|red:dashed] soulignement en pointillés linéaires (rouges)'],
'double'=>['[txt|red:dotted] double soulignement (rouge)'],
'strike'=>['[txt|red:strike] texte barré (rouge)'],
'wavy'=>['[txt|red:wavy] soulignement vagues (rouge)'],
'underover'=>['[txt|red:underover] soulignement dessus et dessous'],
'borderline'=>['[txt|red,2,solid:borderline] bordure-bottom rouge de 2px'],
...
'note'=>['contenu affichable dans une bulle [content|title:note]'],
'notes'=>['résultat des notes de bas de pages collectées par :note'],
...
'time'=>['date'],
'numb'=>['nombre formaté'],
'diagram'=>['progress bar (max 100)'],
'graph'=>['[a|8¬b|2¬c|4|o:graph] //o=div,bar,* (calc width)'],
'artlist'=>['liste d\'articles']]; ?>