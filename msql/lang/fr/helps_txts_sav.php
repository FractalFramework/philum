<?php //msql/helps_txts_sav
$r=["_"=>['description'],
"philum_pub_txt"=>['[[http://philum.fr/236§[phi1§32::picto]:popart] [v[:ver]§txtsmall2:css] [http://philum.fr§[logo:picto]]:center]'],
"update_ok_alert"=>[''],
"conn_help_txt"=>['Les connecteurs remplacent le code html par des fonctions interrogeables avec une séquence de variables, du type de celles-ci :
...
"update_ok"=>['Le logiciel a été mis a jour'],
"update_help"=>['si une erreur survient, entrer en'],
...
- utiliser une virgule pour les recherches booléennes
...
- script de l\'API, ex : \"from:2012-01-01,until:2014-01-01\" (au moins une \',\' et un \':\')'],
...
"suggest"=>['Coller l\'url de l\'article. 
...
"memstorage"=>['les contenus sont stockés dans les variables locales de votre navigateur'],
...
Dans la version /spigrow ont été représentés la position réelle des électrons sur les couronnes, qui subit parfois quelques variations par rapport au modèle idéal de la table.'],
...
"study"=>['Coller un texte dans le champ va créer un tableau composé de chaque phrase du texte dans une cellule associée à d\'autres où on peut ajouter des commentaires'],
...
du ou des mots-liés.'],
"star"=>['exemple 1, avec dc (déclinaison), ra (ascension droite) et dist (degrés et AL) : 
