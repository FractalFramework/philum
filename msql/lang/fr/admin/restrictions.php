...
'8'=>['prw auto','mode de preview auto pour les sous-articles'],
...
'17'=>['colonnes','article sur plusieurs colonnes, d\'après le css \'cols\' ; rnseuls les longs contenus sont affectés'],
'18'=>['définitions publiques','Définitions d\'importation d\'importation de sites.rnChoisissez les defs publiques ou privées via rstr18'],
...
'55'=>['template pubs','pubs d\'articles :rntente d\'abord d\'utiliser un template personnalisé, puis un template public, avant de retourner à celui par défaut.'],
...
'65'=>['template titles','titres de page :rntente d\'abord d\'utiliser un template personnalisé, puis un template public, avant de retourner à celui par défaut.'],
'66'=>['template tracks','commentaires : rntente d\'abord d\'utiliser un template personnalisé, puis un template public, avant de retourner à celui par défaut.'],
'67'=>['template book','connecteur book : rntente d\'abord d\'utiliser un template personnalisé, puis un template public, avant de retourner à celui par défaut.'],
...
'85'=>['desktop','démarre des apps de type desk (affiche le bureau) et affiche les liens dans une popup'],
...
'107'=>['tri langues','bouton de tri à la langue courante'],
...
'145'=>['save videos','Les connecteurs [mp4, mp3, webm, m4a, ogg] ommettent l\'enregistrement, normalement commandé par l\'usage des connecteurs associés.rnSi la rstr est désactivée, c\'est le contraire : seuls les url converties en connecteur (.mp4 => :mp4) occasionnent un enregistrement.'],
...
'152'=>['autoreduce','réduit la largeur des images à 940px'],
'153'=>['progc','dev2'],
...
'160'=>['overcat','couleur de catégorie'],
'161'=>['front','?'],
'162'=>['json','utiliser les templates json'],
'163'=>['glyphes','règle la hauteur des images < 120px à 1 em'],
'164'=>['dico','mots définis'],
'165'=>['plan','plan de l\'article'],
'166'=>['vidéos','importer les vidéos'],
...
'171'=>['edit preview','auto preview'],
'172'=>['search react','affiche les résultats en tapant']]; ?>