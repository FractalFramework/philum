...
La rstr60 permet d\'afficher le résultat dans le corps de l\'article. Dans ce cas il faut spécifier l\'option de largeur de colonne. Elle diminue d\'autant la largeur des images.','Nommer ce bloc','',''],
...
"api"=>['Renvoie le résultat d\'une requête à l\'Api','commande de l\'Api','commande de rectifications',''],
...
"link"=>['renvoie un lien (dans un li)','Lien prédéfini : Home, ID d\'article, nom de catégorie
...
"playconn"=>['articles contenant le connecteur spécifié','spécifier le connecteur en option','',''],
