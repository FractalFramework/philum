...
5=>['0609','rénovation de l\'installateur : typos, dossiers, htaccess, css par défaut...rnajout du fichier vps.txt décrivant toute la démarche pour installer philum dans un VPS (svp en français...)'],
...
8=>['0615','- rénovation du système de cache du flux rssrn- réparation de la gestion des sous-domaines du système de boot'],
9=>['0618','- confiscation d\'un acien protocole devenu obsolète dans les plugins (le get \'plug\'=1)rn- petite réparation des stats d\'articles (image qui bypasse le cache)'],
