...
'center'=>['center align'],
'ajax'=>['return (a button who return) a module or a connector :ajaxrnwhere:rnrn- param/title/command/option:module = call module ;rn- target = div ;rn- button = to screen ;rnrnThat can be repeat to produce a menu like in the module MenusJ.rntry [id:read|screen:ajax] give the content of an article '],
'ajxget'=>['preserve characters | inside connector :module '],
'dskbt'=>['calls a button of type Desk rn- from an existing id: [6:dskbt][6|hello:dskbt]rn- or written on the fly: [button;app;stext:apps]rnsyntax(button;type;process;param;option)'],
...
'link'=>['predefined links :rn- key: Home, ID, catégorie, modulern- title: Home|Accueilrn- picto : Home|home:pictorn- url: /?plug=myplug|name_of_plug rn- key: Home'],
'w'=>['give entire link'],
...
'mini'=>['build a thumbnail with personalized dimensions : [img.jpg|140/100:mini]rn+ open the original in an ajax popup'],
...
'pub'=>['[1234:pub] display buttonrn[1234|1:pub] |2 |3 |4 open article (preview mode)'],
'art'=>['[1234:art] display buttonrn[1234|1:art] |2 |3 |4 open article (preview mode)'],
...
'shop'=>['give all the article affiliated to this one in an unique table of products rn(user_tags can be price and reference)'],
...
'plan'=>['table of contents, using h1, h2...rn [title|option:plan] opt=1 : topologic number'],
