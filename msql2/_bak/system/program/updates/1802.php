...
4=>['0207','suppression du bouton \"par date\" dans le moteur de recherche,najout des boutons \"score\" (classement par le nombre de résultats) et \"langue(s)\"'],
5=>['0208','amélioration de la gestion des auteurs :n- les auteurs sont éditables dans les métas (pour les auth6)n- bouton de récupération du nom d\'auteur d\'un twitn- impossibilité de s\'inscrire avec un nom d\'auteur existant'],
6=>['0209','- ajout du plugin star, permet de faire des requêtes dans la base Hipparcosn- ajout du connecteur :app, permet d\'appeler le constructeur d\'une app. ex: [hd191408§1:star:app] appelle star::build($p,$o) = méthode pour s\'épargner l\'interfacen- ajout du connecteur :search, permet d\'afficher un bouton qui ouvrira le résultat d\'une recherche'],
9=>['0210','- rénovation de la table et ajout d&#8217;icônes ascii (pour les maths), dans l\'éditeur'],
7=>['0211','- rénovation de certaines parties de l\'updateurn- le moteur de recherche accepte désormais les dates'],
8=>['0212','- le moteur de recherche accepte désormais les requêtes de l\'APIn- ajout du module \'desktop_apps\', permet de rejoindre les dispositifs du desktop pour les afficher en tant que module (tout simplement)'],
