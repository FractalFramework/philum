...
return ['_'=>['date','text'],
1=>['0301','publication'],
2=>['0303','- réfection du module tag_cloud (nuage de tags)n- ajout du module frequent_tags : tags les plus fréquents, capable de prendre en compte toutes les classes de tags'],
...
9=>['0312','- mise en conformité html5n- correctif passage à mysqlin- correctif affichage non logué dans msql'],
...
17=>['0320','- tentative mise en berne d\'utiliser le desktop pour faire un random backgroundn- le select_j ne captait pas le param connu (date d\'un nouvel article)n- étude de la remise en marche de rub_tag (vieille fonction rendue obsolète)n- le connecteur :web stocke le résultat de sa capture og dans une table hub_web'],
18=>['0321','- maintenance applicative de Finder, gestion des uploads (les fichiers sont dirigés dans les bons dossiers, accepte .mid, .flac)n- mise en place des éléments d\'un upload par glissement de fichier'],
19=>['0322','- fonctionnement des menus bub (dropmenus) : se positionne dans le menu parent en mode panup, ferme les autres familles de menusn- suppression d\'antiques formulaires, dénoncés par des notices dans le DOM'],
...
22=>['0329','- correctif pb enregistrement secondaire des rstr (celui qui sert en deuxième instance)n- correctif statsee'],
23=>['0330','- le dispositif sconn (connecteurs réduits) est annihilé (les commentaires et autres passent pas les connecteurs classiques) et réhabilité de façon à servir au futur type d\'éditeur compositen- :radio accepte un chemin vers un répertoire au lieu de la table de la playlist, qui dans ce cas peut être fabriquée'],
