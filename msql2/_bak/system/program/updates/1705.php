...
3=>['0503','mise à niveau du dispositif panup :n- le panneau ne recouvre pas le menu de premier niveaun- les css indiquent le menu actif du panneau en cours'],
4=>['0503','finalisation de slct_cases :n- amélioration de la recherche via les tagsn- suppression de l\'antique rech_catag()n- ajout de maxdays() et oldest_art(), pour survenir aux manquements quand rstr3 n\'est pas actif ; maxdays() supporte les dates négatives.'],
