...
61=>['batch_defil_kv','r/here/kv','=array =value of a key of the array kv=usage of the values of the array :nkk=use and echo k;nkv=use k and echo v;nvv=use and echo v;nvk=use v and echo kn-- used by menuder_form_kv','string: <value>$k</value> <option>$v</options> with a checked value','html'],
...
107=>['msql_read','dr/nod/in','directory nod=table i=range (optionnal) :: resolve root problems','array of a table nor a part of it nor only the value there is only one range','microbases'],
