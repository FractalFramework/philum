...
$j=$rid.'_toposlides,call_inp__'; $v=$r[$p]; $bt4='';
...
foreach($r as $k=>$v)$rb[$v[0]][]=$k; if($rb)ksort($rb);
foreach($rb as $k=>$v){sort($v); foreach($v as $vb)$rc[$vb]=$r[$vb];}
return $rc;}
