...
foreach($dom->getElementsByTagName('tr') as $k=>$v){//pr($v);
	...
	if($col=='Statut' or $col=='Adresse (RCS)' or $col=='Code postal' or $col=='Ville' or $col=='Forme juridique' or $col=='Capital social' or $col=='Date cr�ation entreprise' or $col=='Chiffre d\'affaires')$rb[$col]=$val;}
$n=count($rb);
//pr($rb);
return $rb;}
...
$ret.=lj('',$rid.'_capt,call_inp1,inp2',picto('ok')).' ';
return $ret;}
