...
$dr=['jan'=>'jan','fev'=>'feb','mars'=>'mar','avr.'=>'apr','mai'=>'may','juin'=>'jun','juil'=>'jul','ao�t'=>'aug','sept'=>'sep','oct'=>'oct','nov'=>'nov','d�c'=>'dec'];
foreach($r as $k=>$v){$nb++;
//14.12.28 00.50 (122)
...
$r=sql('idart','qdta','rv','idtag="954"','');//1000=author:dav//954=Manuel de Di�guez//994=Aline
//$r=sql::inner('id','qda','qdm','id','rv','nod="MARIALI" and msg like "%Manuel de Di�guez%"','');
pr($r);
//foreach($r as $k=>$v)$rb[$v]=sqlup('qda',['name'=>'Manuel de Di�guez'],['id'=>$v],1);
return $ret;}
...
$d=read_file($f); //eco($d);
if(strpos($d,msql::$m)){
$d=str_replace(msql::$m,'_',$d); echo $f;
write_file($f,$d);}}
