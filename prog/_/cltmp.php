...
_ARTEDIT_FLOAT[_ARTLANG _SOCIAL _WORDS _OPEN|grey right:css][_TAG|small:divc] [:clear][_MSG|[art_ID:id][justy:class]_JS:article]';}
static function cat(){return '
[[_THUMB[_TAG|panel small scrollb:divc]|row1 col1:divc]
...
_FLOAT[_TAG|panel small:divc]:header]
