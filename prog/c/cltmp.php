<?php //template
class cltmp{
static function art(){return '[_CAT_BACK _AVATAR[_SEARCH|txtbox:css] [_NBARTS|txtnoir:css] [_DATE|txtsmall2:css] [_AUTHOR _SOURCE _LENGTH _PRIORITY _BTIM _TRACKS _OPT _LANG _PID|txtsmall:css]|[meta_ID:id]:header][_EDIT|right:css]
...
static function cat(){return '[[_THUMB[_TAG|panel txtsmall scrollb:divc]|row1 col1:divc]
...
|grid-art:divc][:clear]';}
static function read(){return '[[_AVATAR[_SEARCH|txtbox:css]_CAT_BACK [_DATE|txtsmall2:css] [_NBARTS|txtnoir:css] [_AUTHOR _SOURCE _LENGTH _PRIORITY _BTIM _TRACKS _OPT _LANG _PID|txtsmall:css]|[meta_ID:id]:div]
