...
"19"=>['nodes','Les Hubs d\'un site appartiennent à une couche qui s\'exprime par un préfix du nom des bases de données. L\'utilisateur d\'un nouveau nœud obtient non seulement un hub vierge mais aussi une base de données vierge. Ce sont des calques de hubs qui peuvent être superposés, de sorte à présenter un site web différent à chaque nom de domaines.'],
...
"24"=>['templates','Le contenu généré reste sous forme de variables jusqu\'à l\'assemblage où est procédée la mise en forme.
...
"27"=>['update','Le logiciel est régulièrement mis à jour. 
